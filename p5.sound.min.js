  ...
  s = (function (e, i, n) {
    ...
    return (
      ...
      (t.prototype.userStartAudio = function (i, n) {
        var r = i;
        return (
          i instanceof t.Element
            ? (r = i.elt)
            : i instanceof Array &&
              i[0] instanceof t.Element &&
              (r = i.map(function (t) {
                return t.elt;
              })),
          e(o, r, n)
  ...
  u = (function () {
    function e(t) {
      ...
      for (var c = s.length, p = 44, h = 1, l = 0; c > l; l++)
        u.setInt16(p, s[l] * (32767 * h), !0), (p += 2);
      return u;
    }
    function i(t, e) {
      for (
    ...
    return (
        ...
        if ("string" == typeof e) {
          ...
          if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n) > -1)
            if (t.prototype.isFileSupported(n)) i = i;
              ...
              for (
                var r = i.split("."), s = r[r.length - 1], a = 0;
                a < o.extensions.length;
                a++
              ) {
      ...
      { convertToWav: e, midiToFreq: r, noteToFreq: s }
    );
  })(a);
  var c;
  c = (function () {
    ...
    (t.SoundFile = function (e, i, n, o) {
      ...
      (t.SoundFile.prototype.load = function (t, e) {
        ...
        if (void 0 !== this.url && "" !== this.url) {
          ...
          (r.onload = function () {
            i.panner &&
              f.decodeAudioData(r.result, function (e) {
                i.panner &&
                  ((i.buffer = e),
                  i.panner.inputChannels(e.numberOfChannels),
                  t && t(i));
      ...
      (t.SoundFile.prototype.play = function (t, e, i, n, o) {
        ...
        if (
          ...
          "restart" === this.mode &&
            ...
            (this.bufferSourceNode.stop(u), this._counterNode.stop(u)),
          ...
          o && (o = o <= this.buffer.duration - r ? o : this.buffer.duration),
            this._paused
              ? (this.bufferSourceNode.start(u, this.pauseTime, o),
                this._counterNode.start(u, this.pauseTime, o))
              : (this.bufferSourceNode.start(u, r, o),
      ...
      (e.prototype.scale = function (e, i, n, r) {
        ...
        4 === arguments.length
          ? ((s = t.prototype.map(n, e, i, 0, 1) - 0.5),
            (a = t.prototype.map(r, e, i, 0, 1) - 0.5))
      ...
      (t.Oscillator.prototype.scale = function (e, i, n, s) {
        ...
        4 === arguments.length
          ? ((a = t.prototype.map(n, e, i, 0, 1) - 0.5),
            (u = t.prototype.map(s, e, i, 0, 1) - 0.5))
